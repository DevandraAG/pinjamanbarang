...
<main role="main">
    <section class="jumbotron text-center" style="background: #fff;">
        <div class="container">
            ...
            <p>Pilih barang yang ingin dipinjam dari daftar barang di bawah</p>
        </div>
    </section>
    <div class="album py-5 bg-light">
        <div class="container">
            <div class="row">
                ...
                // Establish a MySQLi connection (Update with your own database credentials)
                $mysqli = mysqli_connect("localhost","root","","db_pinjam_barang");
