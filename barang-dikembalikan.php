    ...
    <div class='row'>
        ...
        <div class="col-md-8 form-register-container">
            ...
            <table class="table table-bordered table-super-condensed">
                ...
                <tbody>
                <?php
                include 'config.php'; // Pastikan Anda telah mengonfigurasi koneksi database

                // Gunakan mysqli atau PDO untuk query database
                $query = mysqli_query($koneksi, "SELECT * FROM tbl_transaksi WHERE peminjam='$username' ORDER BY id DESC");
