        ...
        <div class='row'>
            ...
            <div class="col-md-8 form-register-container">
                ...
                <table class="table table-bordered table-super-condensed">
                    ...
                    <tbody>
                        <?php
                        include 'config.php'; // Pastikan file config.php ada dan berfungsi
                        $query = mysqli_query($koneksi, "SELECT * FROM tbl_request WHERE peminjam='$username' ORDER BY id DESC");
